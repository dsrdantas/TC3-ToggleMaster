...
def generate_report():
    ...
    pdf.cell(0, 6, "https://github.com/dsrdantas/TC3-ToggleMaster", new_x="LMARGIN", new_y="NEXT")
    pdf.ln(3)
    ...
    pdf.set_font("Helvetica", "", 10)
    pdf.set_text_color(0, 102, 204)
    pdf.cell(0, 6, "https://github.com/dsrdantas/TC3-ToggleMaster/tree/main/docs", new_x="LMARGIN", new_y="NEXT")
